...
- **Input Schema:**
  ```json
  {
    ...
    "properties": {
      ...
      "continue": {
        "type": "boolean",
        "description": "If true, finalize a merge after conflicts have been resolved. Requires that a merge is in progress and all conflicts are staged."
      }
    },
    "required": [
      "repo_path",
